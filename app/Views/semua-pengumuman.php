...
<div class="container my-5 py-2">
    ...
    <div class="bg-light py-2 px-3 mb-5 rounded-1" style="font-size: 0.85rem;">
        ...
        <span class="text-secondary">Semua Pengumuman</span>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-8 pe-lg-5 mb-5 mb-lg-0">
            ...
            <?php if (!empty($pengumuman)) : ?>
                    ...
                    <div class="row mb-4 pb-4 border-bottom align-items-center">
                        ...
                        <div class="col-md-5 mb-3 mb-md-0">
                            <a href="<?= base_url('pengumuman/' . $p['slug']) ?>">
                                <img src="<?= base_url('assets/img/pengumuman/' . $p['gambar']) ?>" class="img-fluid w-100 rounded-1 shadow-sm border" alt="<?= esc($p['judul']) ?>" style="height: 180px; object-fit: cover;">
                            </a>
                        </div>
                        ...
                        <div class="col-md-7">
                            ...
                            <div class="text-muted mb-3 meta-icon" style="font-size: 0.8rem;">
                                <span class="me-3"><i class="far fa-clock"></i> <?= date('d F Y', strtotime($p['tanggal'])) ?></span>
                                <span class="me-3"><i class="far fa-user"></i> Admin</span>
                            </div>
                            <p class="text-secondary mb-0" style="font-size: 0.9rem; line-height: 1.6; text-align: justify;">
                                <?= esc(substr(strip_tags($p['isi_pengumuman']), 0, 220)) ?>...
                            </p>
                        </div>
                ...
                <?= $pager->links('pengumuman', 'bs5_pager') ?>

            <?php else : ?>
                <div class="alert alert-warning text-center">Belum ada pengumuman yang diterbitkan.</div>
            <?php endif; ?>
